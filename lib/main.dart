...
import 'package:buildmate/viewmodel/org_profile_view_model.dart'; // دعم بروفايل المنظمة
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (_) => OrgProfileViewModel()), // إضافة الـ Provider الخاص بالمنظمة
      ],
      child: const MyApp(),
    ),
  );

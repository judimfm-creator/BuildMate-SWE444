        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      child: vm.pickedImage == null
                          ? Icon(Icons.person,
                              color: deepMediumPurple, size: 50)
                          : null,
                    ),
                    Positioned(
                      bottom: 0,
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                              color: deepMediumPurple, shape: BoxShape.circle),
              ...
              _buildManagementField("City", "e.g. Riyadh",
                  Icons.location_city_outlined, _cityController),
              _buildManagementField("Biography", "Tell us about yourself",
                  Icons.info_outline, _bioController),
              ...
              ..._otherSkillControllers.asMap().entries.map((entry) => Padding(
                    ...
                    child: _buildManagementField("Other Skill", "Add skill",
                        Icons.star_border, entry.value),
                  )),
              TextButton.icon(
                ...
                label: Text("Add Other Skill",
                    style: TextStyle(
                        color: deepMediumPurple, fontWeight: FontWeight.bold)),
              ),
              ...
              _buildManagementField("GitHub Profile", "https://github.com/...",
                  Icons.code_rounded, _githubController,
                  type: TextInputType.url,
